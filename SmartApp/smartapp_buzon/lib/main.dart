...
class _BuzonBodyStateWidget extends State<BuzonBodyWidget>
{
  ...
  Future _showNotificationPackage() async {
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
        'SmartMailBox', 'WebAPIRest', 'Server as a broker',
        importance: Importance.Low, priority: Priority.Max);
    var iOSPlatformChannelSpecifics = IOSNotificationDetails();
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);


    String trendingNewsId = '4';
    await flutterLocalNotificationsPlugin.show(
        0, 'SmartMailBox', 'Hay un nuevo paquete en el buzón.', platformChannelSpecifics,
        payload: trendingNewsId);
  }   
